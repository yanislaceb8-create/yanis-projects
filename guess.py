print("")
print("")
print("\033[1m   Welcom to\033[0m \033[34;1mGuessing Game\033[0m")
print("")
print("")
print(" \033[36;1;4mRules:\033[0m I will pick a number in my minde [1;100] and you will try to guess it.")
print("Do not worry i am going to help you,")
print("when you write a number i will tell you if my number is higher or lower.")
print("")
import random
